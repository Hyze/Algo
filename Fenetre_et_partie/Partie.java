...
public class Partie {
    ...
    Partie(int nb_Ia,ArrayList <String> Nom){//nombre de joueurs recuperer dans le size du ArrayList avec les noms des joueurs
        table = new Fenetre("Poker",1280,720);
        this.tour = 0;
    ...
    private int nbrJoueur(){
        ...
        return cmpt;
                                    ...
                                    // POUR LE JFRAME J'AI MODIFIE ICI
    ...
    private void gestionTapis(){
        switch(this.tour){
            ...
            case 1:
                ...
                for(int i=0;i<3;i++){
                    Carte tmp = this.paquet.remove(alea(0,paquet.getTaille()-1));
                    this.tapis.addCarte(tmp);
                    table.ajoutCarteRiviere(tmp);
                }
        ...
        for(int i=0;i<this.tapis.getTaille();i++){
            System.out.println(this.tapis.getCarte(i));
                        ...
                        // ICI AUSSI MAIS JE SUIS PAS SUR pour ajouter des cartes au joueur
